...
export const Chapter05Horizon = ({ onNextChapter }) => {
  const [imgError, setImgError] = useState(false);
  const data = weddingData.chapter05;
  ...
  return (
    ...
    >
      {/* Background Ocean Horizon & Temple Architecture */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-radial-gradient from-transparent via-charcoal-950/20 to-charcoal-950/60" />
      </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto w-full text-center flex flex-col items-center my-auto">
        ...
        <motion.p
          ...
          className="font-serif text-base sm:text-xl text-ivory-100/80 font-light leading-relaxed max-w-lg mx-auto"
        >
          {data.supportingText}
        </motion.p>
      </div>
